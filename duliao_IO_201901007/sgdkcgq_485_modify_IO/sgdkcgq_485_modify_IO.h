...
//#define pd_hz_out		0//	BIT(DDRC,PC5)//pc5
#define pd_hz_out_bak	0 //	BIT(DDRD,PD0)
//
...
unsigned char uart_tx_buf[15],uart_rx_buf[15];
...
volatile unsigned char uart_frame_head_ok,comm_error_delay,uart_send_enable;
